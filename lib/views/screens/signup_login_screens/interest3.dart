...
Future<void> _updateLanguages() async {
  try {
    final response = await http.post(
      Uri.parse('$flaskBaseUrl/update_languages'),
...
Future<void> _fetchLanguages() async {
  try {
    final response = await http.get(Uri.parse('$flaskBaseUrl/get_languages'));
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        "Tell us what language you can speak",
                        style: GoogleFonts.outfit(
                          color: Colors.black,
                          fontWeight: FontWeight.w800,
                          fontSize: 21,
