                            ...
                            children: [
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  await userDoc
                                      .update({'preferredStudyTimes': selectedTimes});
                                },
                                child: Container(
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  await userDoc.update(
                                      {'preferredStudyMethods': selectedMethods});
                                },
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: (screenWidth * 0.05)),
                      ...
                      children: [
                        GestureDetector(
                          onTap: () async {
                            ...
                            await userDoc
                                .update({'academicStrengths': selectedStrength});
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(
                                horizontal: (screenWidth * 0.05)),
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: skills.map((label) {
                    final bool isSeleceted = selectedSkills.contains(label);
                    return Row(
                      children: [
                        GestureDetector(
                          onTap: () async {
