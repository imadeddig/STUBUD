...
class _FieldState extends State<Field> {
  ...
  Future<void> updateField(String userID, String field) async {
  final url = Uri.parse('$flaskBaseUrl/update_field'); 
                ...
                child: Column(
                  children: filterFields.map((field) {
                    return GestureDetector(
                      ...
                      await updateField(widget.userID, field);
                      fetchSpeciality(selectedField!);
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(
                          vertical: 10,
