  ...
  Future<void> _fetchInterests() async {
    try {
      ...
      if (docSnapshot.exists) {
        final List<dynamic>? interestsArray = docSnapshot['interest2'];
                      ...
                      children: _filteredLabel.map((label) {
                        ...
                        return GestureDetector(
                          onTap: () async {
                            ...
                            try {
                                final userInterestDoc = FirebaseFirestore
                                    .instance
                                    .collection('userInterest2')
                                    .doc(widget.userID);

                                await userInterestDoc.set(
                                  {
                                    'userID': widget.userID,
                                    'selectedInterests': _selectedLabels.toList(),
                                  },
