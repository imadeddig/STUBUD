...
class ChatSessionsDB {
  ...
  static Future<List<Map<String, dynamic>>> getChatSessionsByUserID(String userID) async {
    try {
      final database = await DBHelper.getDatabase();
...
Future<List<Map<String, dynamic>>> fetchAllMessagesForChat(String chatID) async {
...
static Future<List<Map<String, dynamic>>> getChatSessions(String userID) async {
  final db = await DBHelper.getDatabase();
